...
대표 fixture는 80×50×3 mm 판, Ø3.2 관통홀 4개, 가장자리 5 mm, 수직 모서리 R2입니다. Rectangle sketch → 3 mm new-body extrude → 네 개의 explicit through-all hole centre → vertical-edge fillet 순서로 표현합니다.
